...
Baseline implementation for architectural comparison
...
class Up(nn.Module):
    ...
    def forward(self, x1: torch.Tensor, x2: torch.Tensor) -> torch.Tensor:
        x1 = self.up(x1)
        # Handle size mismatch caused by pooling/upsampling
...
class UNet(nn.Module):
    """
    U-Net for surgical instrument segmentation
    ...
    def __init__(self, n_channels: int = 3, n_classes: int = 2, bilinear: bool = False):
        super().__init__()
